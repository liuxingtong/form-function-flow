...
export function bindLayerToggles(map) {
  const checks = [
    ...
    { id: "lyr-walking", layers: ["rhino-walking-line", "rhino-walking-fill"] },
    { id: "lyr-ground", layers: ["rhino-ground-fill", "rhino-ground-line"] },
    { id: "lyr-landuse", layers: ["landuse-fill", "landuse-selected-line", "zone-parcels-line"] },
